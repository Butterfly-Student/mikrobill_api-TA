...
func NewPingHandler(client *mikrotik.Client, repo entity.CustomerRepository) *PingHandler {
	return &PingHandler{
		client: client,
		repo:   repo,
	}
...
func (h *PingHandler) getCustomerIPAddress(customer *entity.Customer) (string, error) {
