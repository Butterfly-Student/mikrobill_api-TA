...
// DatabaseCustomerRepository implements entity.CustomerRepository
...
func (r *DatabaseCustomerRepository) GetActivePPPoECustomers() ([]*entity.Customer, error) {
...
func (r *DatabaseCustomerRepository) GetCustomerByID(id string) (*entity.Customer, error) {
...
func (r *DatabaseCustomerRepository) GetCustomerByPPPoEUsername(username string) (*entity.Customer, error) {
...
func (r *DatabaseCustomerRepository) UpdateCustomerStatus(id string, status string, ipAddress *string, macAddress *string, interfaceName *string) error {
	...
	if interfaceName != nil {
		log.Printf("[CustomerRepo] UpdateCustomerStatus - Setting interface name: %s\n", *interfaceName)
...
func (r *DatabaseCustomerRepository) CreateCustomer(c *entity.Customer) error {
...
func (r *DatabaseCustomerRepository) UpdateCustomer(c *entity.Customer) error {
...
func (r *DatabaseCustomerRepository) DeleteCustomer(id string) error {
	result := r.db.Where("id = ?", id).Delete(&entity.Customer{})
...
func (r *DatabaseCustomerRepository) ListCustomers(page, limit int) ([]*entity.Customer, int, error) {
	var customers []*entity.Customer
	var total int64
	
	// Count total
	err := r.db.Model(&entity.Customer{}).Count(&total).Error
	if err != nil {
