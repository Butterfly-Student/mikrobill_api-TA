...
function connectTrafficWebSocket(customerId) {
    const trafficWsUrl = `ws://localhost:8080/api/customers/${customerId}/traffic/ws`;
...
async function updateSystemStats() {
    try {
        const baseUrl = typeof API_BASE !== 'undefined' ? API_BASE : 'http://localhost:8080';
...
function startPingWs(customerId) {
    ...
    const wsUrl = `ws://localhost:8080/api/customers/${customerId}/ping/ws`;
