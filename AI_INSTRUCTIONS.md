# Mikrotik Billing API Project Instructions for AI Assistants

This file contains instructions for AI coding assistants working with the Mikrotik Billing API project.
